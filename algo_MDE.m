...
Example Usage : 
mydata.fncno = 28;  out  = algo_MDE('cec2013' , mydata ,  30 , 20 , -100 , 100 , 100e5 , 5)
...
for cycle  =  1 : MaxCycle
    ...
    fprintf('%5.0f -- >  %5.16f \n' ,  cycle ,  BestVal ) ;
    moment  =  B  .*  10.^randi([-12 -9] , N , D) .* (rand(N , 1)-0.50);
end
